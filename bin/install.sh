...
test -L ${XDG_CONFIG_HOME:-$HOME/.config}/bash || ln -sv $base_path/bash $CONFIG_HOME/
test -L ${XDG_CONFIG_HOME:-$HOME/.config}/zsh || ln -sv $base_path/zsh $CONFIG_HOME/
test -L ${XDG_CONFIG_HOME:-$HOME/.config}/fish || ln -sv $base_path/fish $CONFIG_HOME/
test -L ${XDG_CONFIG_HOME:-$HOME/.config}/git || ln -sv $base_path/git $CONFIG_HOME/
test -L ${XDG_CONFIG_HOME:-$HOME/.config}/vim || ln -sv $base_path/vim $CONFIG_HOME/
