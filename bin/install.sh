...
test -f "$zdotdir/.zlogin" || cp -v $BASE_DIR/zsh/dot/zlogin $zdotdir/.zlogin
test -f "$zdotdir/.zshrc" || cp -v $BASE_DIR/zsh/dot/zshrc $zdotdir/.zshrc
test -f "$zdotdir/.zplugrc" || cp -v $BASE_DIR/zsh/dot/zplugrc.prezto $zdotdir/.zplugrc
