...
function __fish_sdkman_installed_candidates
  ls -v1 $SDKMAN_DIR/candidates
end
...
complete -c sdk -f -n '__fish_sdkman_using_command use' -a "(__fish_sdkman_installed_candidates)"
complete -c sdk -f -n '__fish_sdkman_using_command u' -a "(__fish_sdkman_installed_candidates)"
